...
#include "Graph.h"
    ...
    //Initialization
Graph::Graph(const int n, const int eT, const int sT, const int start_n, const int end_n) {
        startT = sT;
        endT = eT;
        this->n = n;
        startN = start_n;
    ...
    void Graph::addNode(const int i) {
        Node newNode(i);
        nodes.push_back(newNode);
    }

    void Graph::addNodes(const int n) {
        for (int i = 0; i < n; i++) {
            addNode(i);
        }
    }

    void Graph::addArc(const int start_idx, const int end_idx, vector<double> travel_times) {
    ...
    //Functions
    double Graph::TT(const int start_idx, const int end_idx, const double start_t) { // TT = Time Travel
        /*
    ...
    double Graph::iTT(const int start_idx, const int end_idx, const double end_t) { // iTT = Inverse Time Travel
        /*
    ...
    vector<double> Graph::FSPT(const int start_idx, const double start_t, vector<TypeArc> &arcs) {
    ...
    vector<double> Graph::BSPT(const int end_idx, const double end_t, vector<TypeArc> &arcs) {
    ...
    double Graph::minTT(const int start_idx, const int end_idx, double left_t, double right_t) {
    ...
    int Graph::min_idx_TT(const int start_idx, const int end_idx, const int left_t, const int right_t) {
